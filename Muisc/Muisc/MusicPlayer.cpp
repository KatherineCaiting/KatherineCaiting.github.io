...
BOOL CALLBACK DlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch (message)
	{
		...
		case WM_CTLCOLORLISTBOX:
		{
			...
			//SetBkColor((HDC)wParam, RGB(176, 226, 255));
		...
		case WM_CONTEXTMENU:
		{
			if ((HWND)wParam==GetDlgItem(hDlg,IDC_LIST1))
			{
...
BOOL Cls_OnInitDialog(HWND hwnd, HWND hwndFocus, LPARAM lParam)
{
	...
	DefualtpProc = (WNDPROC)SetWindowLong(GetDlgItem(hwnd, IDC_LIST1), GWLP_WNDPROC, (LONG)ListBoxProc);
...
LRESULT CALLBACK ListBoxProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	return DefualtpProc(hwnd,message,wParam,lParam);
}
